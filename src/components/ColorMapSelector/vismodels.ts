import type { BooleanType, ComplexType, NumericType, StringType } from './models-hdf5'

import type { AxisScaleType, ColorScaleType, Domain, NumArray, ScaleType } from './models-vis'
...
export type Scale<S = ScaleType> = S extends ColorScaleType ? PickD3Scale<S, number> : ScaleGamma
...
export type PrintableType = BooleanType | NumericType | ComplexType | StringType
