    ...
    .right-panel(v-if="!thumbnail" :darkMode="true")
      ...
      .detail-area
        ...
        .lspShipmentChains(v-if="activeTab=='lspShipmentChains'")
            ...
            .leaf.tour(v-for="lspShipmentChain,i in lspShipmentChains" :key="`${i}-${lspShipmentChain.shipmentId}`") {{ `${lspShipmentChain.shipmentId}: ${lspShipmentChain.chainId}` }}
