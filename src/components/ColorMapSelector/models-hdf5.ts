...
export type ProvidedEntity = GroupWithChildren | Dataset | Datatype | UnresolvedEntity
...
export interface Dataset<S extends Shape = Shape, T extends DType = DType> extends Entity {
...
export type DType = PrintableType | CompoundType | ArrayType | EnumType | UnknownType
